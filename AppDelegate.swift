...
class AppDelegate: UIResponder, UIApplicationDelegate, AVAudioPlayerDelegate{
    ...
    func application(_ application: UIApplication, didReceive notification: UILocalNotification) {
        ...
        let alarmNotificationVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "AlarmNotificaitonViewController") as! AlarmNotificaitonViewController
        ...
        if let userInfo = notification.userInfo {
            ...
            alarmNotificationVC.userInfo = userInfo
        }
        window?.visibleViewController?.navigationController?.present(alarmNotificationVC, animated: true, completion: nil)
    }
